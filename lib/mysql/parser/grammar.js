...
var grammar = {
    ...
    {"name": "O_DEFAULT_VALUE$ebnf$1$subexpression$1$ebnf$1", "symbols": ["O_DEFAULT_VALUE"], "postprocess": id},
    {"name": "O_DEFAULT_VALUE$ebnf$1$subexpression$1$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "O_DEFAULT_VALUE$ebnf$1$subexpression$1", "symbols": [(lexer.has("S_LPARENS") ? {type: "S_LPARENS"} : S_LPARENS), "_", "O_DEFAULT_VALUE$ebnf$1$subexpression$1$ebnf$1", "_", (lexer.has("S_RPARENS") ? {type: "S_RPARENS"} : S_RPARENS)], "postprocess": d => d.join('')},
    ...
    {"name": "P_CREATE_TABLE$subexpression$1", "symbols": ["P_CREATE_TABLE_LIKE"], "postprocess": id},
    ...
    {"name": "P_CREATE_TABLE_COMMON$ebnf$1$subexpression$1", "symbols": ["__", (lexer.has("K_OR") ? {type: "K_OR"} : K_OR), "__", (lexer.has("K_REPLACE") ? {type: "K_REPLACE"} : K_REPLACE)]},
    ...
    {"name": "P_CREATE_TABLE_COMMON$ebnf$2$subexpression$1", "symbols": ["__", (lexer.has("K_TEMPORARY") ? {type: "K_TEMPORARY"} : K_TEMPORARY)]},
    ...
    {"name": "P_CREATE_TABLE_COMMON$ebnf$3$subexpression$1", "symbols": ["__", (lexer.has("K_IF") ? {type: "K_IF"} : K_IF), "__", (lexer.has("K_NOT") ? {type: "K_NOT"} : K_NOT), "__", (lexer.has("K_EXISTS") ? {type: "K_EXISTS"} : K_EXISTS)]},
    {"name": "P_CREATE_TABLE_COMMON$ebnf$3", "symbols": ["P_CREATE_TABLE_COMMON$ebnf$3$subexpression$1"], "postprocess": id},
    {"name": "P_CREATE_TABLE_COMMON$ebnf$3", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "P_CREATE_TABLE_COMMON$ebnf$4$subexpression$1", "symbols": ["_", "P_CREATE_TABLE_OPTIONS"], "postprocess": d => d[1]},
    {"name": "P_CREATE_TABLE_COMMON$ebnf$4", "symbols": ["P_CREATE_TABLE_COMMON$ebnf$4$subexpression$1"], "postprocess": id},
    {"name": "P_CREATE_TABLE_COMMON$ebnf$4", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "P_CREATE_TABLE_COMMON", "symbols": [(lexer.has("K_CREATE") ? {type: "K_CREATE"} : K_CREATE), "P_CREATE_TABLE_COMMON$ebnf$1", "P_CREATE_TABLE_COMMON$ebnf$2", "__", (lexer.has("K_TABLE") ? {type: "K_TABLE"} : K_TABLE), "P_CREATE_TABLE_COMMON$ebnf$3", "__", "S_IDENTIFIER", "_", "P_CREATE_TABLE_CREATE_DEFINITIONS", "P_CREATE_TABLE_COMMON$ebnf$4", "S_EOS"], "postprocess":  d => {
          return {
    ...
    {"name": "P_SET$ebnf$1$subexpression$1", "symbols": ["S_IDENTIFIER"]},
    {"name": "P_SET$ebnf$1$subexpression$1", "symbols": [(lexer.has("S_EQUAL") ? {type: "S_EQUAL"} : S_EQUAL)]},
    ...
    {"name": "P_SET$ebnf$1$subexpression$2", "symbols": ["S_IDENTIFIER"]},
    {"name": "P_SET$ebnf$1$subexpression$2", "symbols": [(lexer.has("S_EQUAL") ? {type: "S_EQUAL"} : S_EQUAL)]},
    ...
    {"name": "P_SET", "symbols": [(lexer.has("K_SET") ? {type: "K_SET"} : K_SET), "__", "P_SET$ebnf$1", "S_EOS"], "postprocess":  d => {
          return {
            id: 'P_SET',
            def: null
          }
